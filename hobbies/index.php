...
<body>
  ...
  <div class="container">
    ...
    <progress id="progressBar" value="70" max="100" style="width:420px;height:15px;"></progress>
        ...
        <?php if (mysqli_num_rows($result) > 0) : ?>
          ...
          ?>
            ...
            <tr>
              ...
              <?php if ($status == 'Paid') : ?>
                <td><a href="../functions/edit_hobby.php?id=<?php echo $id; ?>" style="color:blue !important">
                    <i class="fa fa-edit"></i>Edit</a></td>
                <td><a href="../functions/delete_hobby.php?id=<?php echo $id; ?>" style="color:red !important"><i class="fa fa-phone fa-trash"></i>Delete</a></td>
              <?php endif ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fa fa-bicycle" aria-hidden="true"></i>My Hobbies Details</h1>
